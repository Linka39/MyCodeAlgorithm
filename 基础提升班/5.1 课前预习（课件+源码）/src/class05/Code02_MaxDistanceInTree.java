 ...
 * 树形dp套路  
 * 树形dp套路使用前提：
 * 如果题目求解目标是S规则，则求解流程可以定成以每一个节点为头节点的子树
 * 在S规则下的每一个答案，并且最终答案一定在其中
 *
